...
from Pillow import Image                           # Membuka gambar
...
def main():
    ...
    # Menangani kesalahan jika file "hour.csv" dan "day.csv" tidak ditemukan
    except FileNotFoundError:
        st.error("Error: Pastikan file 'hour.csv' dan 'day.csv' berada dalam direktori yang sama dengan script ini.")
